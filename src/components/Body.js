  ...
  const fetchData = async () => {
    try {
      ...
      if (restaurants) {
        ...
        console.warn(
          "Could not find restaurant data. Swiggy may have updated their structure."
        );
      }
    } catch (err) {
    ...
    <div className="Body">
      <div className="filter flex">
        <div className="search m-4 p-4 bg-pink-50 ">
          ...
          <button
            className="search-btn bg-green-100 px-3 py-2 m-2 rounded-4xl border border-solid border-black"
            onClick={() => {
